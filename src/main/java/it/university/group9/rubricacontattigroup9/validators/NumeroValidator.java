 ...
 * @brief Questa classe contiene il metodo per la validazione di un numero di
 * telefono.
 *
 * La classe fornisce un metodo statico per verificare se un numero di telefono
 * è valido, secondo un pattern regolare. Se il numero non è valido, viene
 * lanciata un'eccezione di tipo NumeroNonValidoException.
 *
 * @author Gruppo09
 * @date 05/12/2024
 * @version 1.0
 ...
 *
 * La classe fornisce un metodo per validare una stringa che rappresenta un
 * numero di telefono. Se il numero non è valido, viene generata un'eccezione.
 */
public class NumeroValidator {
     ...
     *
     * Questo metodo verifica che il numero di telefono rispetti un formato
     * valido. Il numero deve contenere solo cifre e può iniziare con un "+"
     * opzionale. Inoltre, deve avere una lunghezza compresa tra 10 e 15
     * caratteri.
     *
