...
public interface GestioneRubrica {
    ...
    /**
     * @brief Aggiunge un nuovo contatto alla rubrica se tutti i campi sono
     * validi e il contatto non è un duplicato
     *
    ...
    /**
     * @brief Modifica un contatto esistente nella rubrica se tutti i campi sono
     * validi e la modifica non genera un duplicato
     *
     ...
     * @throw CampoNonValidoException Se uno dei nuovi campi forniti non è
     * valido.
     * @see ContattoValidator
     * @see GestioneDuplicati
     */
     ...
     *
     * @post il contatto viene eliminato sia dalla rubrica che dalla rubrica dei
     * preferiti
     */
